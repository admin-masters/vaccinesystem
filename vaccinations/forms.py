...
class AddChildForm(forms.Form):
    ...
    def clean_parent_whatsapp(self):
        e164 = normalize_msisdn(self.cleaned_data["parent_whatsapp"])
        if len("".join(ch for ch in e164 if ch.isdigit())) < 10:
...
class VerifyWhatsAppForm(forms.Form):
    ...
    def clean_whatsapp(self):
        return normalize_msisdn(self.cleaned_data["whatsapp"])
